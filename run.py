...
from util.join import creat_dict, get_vertical_partitions, hashjoin, sortmergejoin, gracehashjoin
import time

if __name__ == '__main__':
    start = time.time()
    int_dict, str_dict = creat_dict()
    follows = BigList(root="1_hash_big_follows", max_length=int(1e07))
    ...
    friendOf = BigList(root="1_hash_big_friendOf", max_length=int(1e07))
    ...
    Join_1 = BigList(root="1_hash_big_Join_1", max_length=int(1e07))
